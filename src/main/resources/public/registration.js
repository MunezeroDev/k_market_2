class RegistrationManager {
  ...
  init() {
    ...
    document
      .getElementById("updateAccountType")
    ...
    document
      .getElementById("confirmAccountType")
  ...
  updateDisplay() {
    ...
    this.accountTypeDisplay.textContent =
      displayText[this.currentAccountType] || "Buyer";
  }

  showModal() {
    const radio = document.querySelector(
      `input[name="accountType"][value="${this.currentAccountType}"]`,
    );
    if (radio) {
      radio.checked = true;
    }
